...
<script>
	 ...
	 * @property {String Number} show-count 模式为mutil-column-auto的时候指定显示几列 默认0按 children 数量
...
export default {
	props: {
		...
		// 模式为mutil-column-auto的时候指定显示几列 默认0按 children 数量
		showCount:{
			type: [String, Number],
			default: 0
		}
