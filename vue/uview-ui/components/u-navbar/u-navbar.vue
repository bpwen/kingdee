<template>
	<view class="u-main-navbar">
		<view class="u-navbar" :style="[navbarStyle]" :class="{ 'u-navbar-fixed': isFixed, 'u-border-bottom': borderBottom }">
			<view :style="{ height: Number(navbarHeight) + statusBarHeight + 'px' }"></view>
		</view>
		<view class="u-navbar u-navbar-main" :style="[navbarStyleA]" :class="{ 'u-navbar-fixed': isFixed }">
			...
			<view class="u-navbar-inner" :style="[navbarInnerStyle]">
				...
				<view class="u-navbar-content-title" v-if="title" :style="[titleStyle]">
					...
					<template v-else-if="typeof title == 'object'">
...
<script>
	...
	export default {
		...
		computed: {
			...
			navbarStyleA() {
				let style = {};
				style.zIndex = (this.zIndex ? this.zIndex : this.$u.zIndex.navbar) + 1;
				return style;
			},
			// 导航中间的标题的样式
			titleStyle() {
