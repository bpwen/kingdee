<template>
	<view class="style-flex style-flex-wrap">
		<filter-radio-item v-for="(item, index) in items" :key="index" :name="item.name" :value="item.value" :checked="item.checked" @change="radioChange"></filter-radio-item>
	</view>
</template>

<script>
	//单选多选
	//https://ext.dcloud.net.cn/plugin?id=136
